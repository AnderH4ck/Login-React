...
function Register() {
    const {
      ...
      const [isChecked, setIsChecked] = useState(true);
        const handleCheckboxChange  = () => {
          setIsChecked(!isChecked); // Cambia el estado de isChecked
        };
    

      const onSubmit = (data) => {
        const { user, email, password, estado} = data;
  ...
  return (
    <div className="bg-cyan-950 p-8 rounded-xl w-full md:w-96">
      ...
      <div className="mb-10">
        <h1 className="text-white text-4xl p-2 uppercase font-bold text-center">REGISTER</h1>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)}
       ...
       <div className="relative">
        ...
        <div className="w-full flex justify-between py-1" >
         <h1 className=" text-white ">Estado de Usuario:</h1> 
